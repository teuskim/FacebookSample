...
package com.teuskim.facebooksample.friendpicker;
...
public class PickFriendsActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        friendPickerFragment.setOnDoneButtonClickedListener(new PickerFragment.OnDoneButtonClickedListener() {
            ...
            public void onDoneButtonClicked(PickerFragment<?> fragment) {
                ...
                FacebookSampleApplication application = (FacebookSampleApplication) getApplication();
    ...
    protected void onStart() {
        ...
        try {
            ...
            /*
             * com.facebook.widget.FriendPickerFragment 이게 따로 만들어져 있다.
             * 여기서 loadData 를 호출하면 친구 목록을 불러오는데, 해당 앱을 설치했던 친구들만 보여준다.
             * 따라서 개발 중인 앱에서 테스트할 경우 당연히 아무도 보이지 않는다.
             */
